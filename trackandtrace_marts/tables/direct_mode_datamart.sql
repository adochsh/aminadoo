...
--changeset 60067166:create:table:trackandtrace_marts.direct_mode_datamart

CREATE TABLE direct_mode_datamart (
  ...
  pi_number text  ENCODING (compresslevel=1,compresstype=zstd,blocksize=32768),
  pi_date date  ENCODING (compresslevel=1,compresstype=zstd,blocksize=32768),
  ...
  doc_batch_issue date ENCODING (compresslevel=1,compresstype=zstd,blocksize=32768),
...
--changeset 60115905:alter:table:trackandtrace_marts.import_datamart:change_total_volume_type
ALTER TABLE direct_mode_datamart
ALTER COLUMN invoice_total_volume TYPE text;

--changeset 60115905:alter:table:trackandtrace_marts.import_datamart:add_cd_columns
ALTER TABLE direct_mode_datamart
...
ALTER COLUMN doc_batch_issue type text;
