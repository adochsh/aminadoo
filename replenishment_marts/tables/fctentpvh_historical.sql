...
--changeset 60098727:create:table:fctentpvh_historical:change_partitioning

create table fctentpvh_historical (
...
PARTITION BY RANGE (pvedmaj) (DEFAULT PARTITION other);
